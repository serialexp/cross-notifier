...
mod tests {
    ...
    async fn in_memory_register_list_unregister() {
        ...
        reg.register("tok1".into(), "iPhone".into(), Platform::Ios).await;
        reg.register("tok2".into(), "Pixel".into(), Platform::Android).await;
    ...
    async fn persists_across_reload() {
        ...
        let labels: std::collections::HashSet<String> = reloaded
            .list()
            .await
            .into_iter()
            .map(|d| d.label)
